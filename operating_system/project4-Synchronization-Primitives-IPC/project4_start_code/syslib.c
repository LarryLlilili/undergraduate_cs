...
void usr_lock_init(int lock_id){
	invoke_syscall(USR_LOCK_INIT, lock_id, IGNORE, IGNORE);
}

void usr_lock_acquire(int lock_id){
	invoke_syscall(USR_LOCK_ACQUIRE, lock_id, IGNORE, IGNORE);
}

void usr_lock_release(int lock_id){
	invoke_syscall(USR_LOCK_RELEASE, lock_id, IGNORE, IGNORE);
}
